...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/auth/validate-login', [LoginController::class, 'validateLogin'])->name('validate-login');
    //public key        
    ...
    Route::get('/reset-password/{token}', [ForgotPasswordController::class,'resetForm'])->name('reset-password');
...
Route::prefix('app')->middleware(['session.security','no.cache'])->group(function () {
